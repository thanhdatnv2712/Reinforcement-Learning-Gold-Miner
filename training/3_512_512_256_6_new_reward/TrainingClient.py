...
for episode_i in range(0, N_EPISODE):
    ...
    for step in range(0, maxStep):
        ...
        s = s_next #Assign then next state for the next step.
        # Saving data to file
    ...
    print ("\t| Total step: ", total_step, "\t| Total random step: ", agent.count, "\t| Total Reward: ", total_reward, "\t| Score: ", minerEnv.state.score)
    print (action_game)
    if episode_i % 100 == 0:
